...
public class JwtGeneratorFilter extends OncePerRequestFilter {
    public AppUserServ appUserServ;
...
//    @Override
//    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
//        return !request.getServletPath().equals("/auth/sign-in");
//    }

//    @Override
//    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
//        // Skip the filter for login requests
//        boolean shouldNotFilter = request.getServletPath().equals("/auth/sign-in");
//        log.info("Skipping JWT generation for path {}: {}", request.getServletPath(), shouldNotFilter);
//        return shouldNotFilter;
//    }
