...
public interface AssessmentSummaryServ {
    ...
    List<AssessmentSummaryGetDto> sorchAllAssessmentSummaryGet(String keyword, String column, String order, int page, int pageSize, String divisionId, int assessmentYear);
}
